...
public class Boss1 : MonoBehaviour
{
    ...
    [SerializeField] private int healthnow;
    ...
    [SerializeField] private float attackDam = 5f;
    ...
    [SerializeField] private int IntCoin = 10;
    [SerializeField] private float healDropRate = 0.2f;

    [Header("Victory")]
    [SerializeField] private GameObject Poinend;
    ...
    protected void Die()
    {
        ...
        Poinend.gameObject.SetActive(true);
    }
