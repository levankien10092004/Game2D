...
public class EnemyThrower : MonoBehaviour
{
    ...
    [SerializeField] private Transform firePoint;         // Vị trí tạo đạn
    [SerializeField] private float attackRange = 10f;      // Khoảng cách tấn công
    [SerializeField] private float attackCooldown = 2f;   // Thời gian hồi chiêu
